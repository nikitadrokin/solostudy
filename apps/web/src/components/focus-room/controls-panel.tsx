...
export default function ControlsPanel({
  ...
  return (
    <Card className="bg-background/80 backdrop-blur-sm">
      <CardHeader>
        <CardTitle className="text-lg">Focus Room Controls</CardTitle>
      </CardHeader>
      <CardContent>
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          {/* YouTube Controls */}
          <div className="space-y-4">
            <h3 className="mb-2 font-medium">Video Background</h3>
          ...
          {/* Audio Controls */}
          <div className="space-y-4">
            <h3 className="mb-2 font-medium">Audio Settings</h3>
